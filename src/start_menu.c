...
static const struct MenuAction sStartMenuItems[] =
{
    ...
    [MENU_ACTION_QUEST_MENU]      = {sText_MenuQuests,  {.u8_void = StartMenuQuestMenuCallback}},
};
...
static bool32 PrintStartMenuActions(s8 *pIndex, u32 count)
{
    ...
    do
    {
        ...
        {
            PrintPlayerNameOnWindow(GetStartMenuWindowId(), sStartMenuItems[sCurrentStartMenuActions[index]].text, 8, (index * 14) + 9);
        }
        else
        {
            StringExpandPlaceholders(gStringVar4, sStartMenuItems[sCurrentStartMenuActions[index]].text);
            AddTextPrinterParameterized(GetStartMenuWindowId(), FONT_NARROW, gStringVar4, 8, (index * 14) + 9, TEXT_SKIP_DRAW, NULL);
        }
...
static bool32 InitStartMenuStep(void)
{
    ...
    case 4:
        ...
        break;
    case 5:
        sStartMenuCursorPos = InitMenuNormal(GetStartMenuWindowId(), FONT_NARROW, 0, 9, 14, sNumStartMenuActions, sStartMenuCursorPos);
