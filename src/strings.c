...
const u8 gText_SideQuestName_2[] = _("Field Research");
...
const u8 gText_SideQuestDesc_2[] = _("Catch 20 different\nPOKéMON species.");
...
const u8 gText_SideQuestDoneDesc_2[] = _("Helped the Aide with\nfield research data.");
