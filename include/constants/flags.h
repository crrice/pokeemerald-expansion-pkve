...
#define FLAG_STAT_EDITOR_IV_UNLOCK 0x24
...
#define FLAG_RECEIVED_MACHO_BRACE_OLDALE     0x1AA
#define FLAG_RECEIVED_WIMPY_BRACE_OLDALE     0x1AB
...
#define FLAG_SYS_QUEST_MENU_GET                      (SYSTEM_FLAGS + 0x3) // Adds QUESTS to start menu
