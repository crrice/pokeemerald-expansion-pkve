...
#define QUEST_FIELD_RESEARCH 0
#define QUEST_BERRY_THIEF 1
#define QUEST_3          2
#define QUEST_4          3
#define QUEST_5          4
#define QUEST_6          5
...
#define QUEST_FIELD_RESEARCH_SUB_COUNT 0
#define QUEST_2_SUB_COUNT 20  // Legacy - used by sSubQuests2 placeholder array
